...
type VerifiableCredential struct {
	...
	//	*VerifiableCredential_CapabilityCred
	//	*VerifiableCredential_ArbitraryCred
...
type VerifiableCredential_CapabilityCred struct {
	CapabilityCred *CapabilityCredentialSubject `protobuf:"bytes,11,opt,name=capability_cred,json=capabilityCred,proto3,oneof" json:"capability_cred,omitempty"`
}
type VerifiableCredential_ArbitraryCred struct {
	ArbitraryCred *ArbitraryCredentialSubject `protobuf:"bytes,12,opt,name=arbitrary_cred,json=arbitraryCred,proto3,oneof" json:"arbitrary_cred,omitempty"`
}
...
func (*VerifiableCredential_CapabilityCred) isVerifiableCredential_CredentialSubject()   {}
func (*VerifiableCredential_ArbitraryCred) isVerifiableCredential_CredentialSubject()    {}
...
func (m *VerifiableCredential) GetCapabilityCred() *CapabilityCredentialSubject {
	if x, ok := m.GetCredentialSubject().(*VerifiableCredential_CapabilityCred); ok {
		return x.CapabilityCred
	}
	return nil
}

func (m *VerifiableCredential) GetArbitraryCred() *ArbitraryCredentialSubject {
	if x, ok := m.GetCredentialSubject().(*VerifiableCredential_ArbitraryCred); ok {
		return x.ArbitraryCred
	}
	return nil
}
...
func (*VerifiableCredential) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*VerifiableCredential_CapabilityCred)(nil),
		(*VerifiableCredential_ArbitraryCred)(nil),
	}
}
...
type ArbitraryCredentialSubject struct {
	// The value of id represents the ID of the credential_subject
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
...
func (m *ArbitraryCredentialSubject) Reset()         { *m = ArbitraryCredentialSubject{} }
func (m *ArbitraryCredentialSubject) String() string { return proto.CompactTextString(m) }
func (*ArbitraryCredentialSubject) ProtoMessage()    {}
func (*ArbitraryCredentialSubject) Descriptor() ([]byte, []int) {
	return fileDescriptor_cf6469f22440938e, []int{9}
}
func (m *ArbitraryCredentialSubject) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ArbitraryCredentialSubject) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ArbitraryCredentialSubject.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ArbitraryCredentialSubject) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ArbitraryCredentialSubject.Merge(m, src)
}
func (m *ArbitraryCredentialSubject) XXX_Size() int {
	return m.Size()
}
func (m *ArbitraryCredentialSubject) XXX_DiscardUnknown() {
	xxx_messageInfo_ArbitraryCredentialSubject.DiscardUnknown(m)
}

var xxx_messageInfo_ArbitraryCredentialSubject proto.InternalMessageInfo

func (m *ArbitraryCredentialSubject) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *ArbitraryCredentialSubject) GetType() string {
	if m != nil {
		return m.Type
	}
	return ""
...
func (m *ArbitraryCredentialSubject) GetAttributes() []byte {
	if m != nil {
		return m.Attributes
	}
	return nil
...
type CapabilityCredentialSubject struct {
...
func (m *CapabilityCredentialSubject) Reset()         { *m = CapabilityCredentialSubject{} }
func (m *CapabilityCredentialSubject) String() string { return proto.CompactTextString(m) }
func (*CapabilityCredentialSubject) ProtoMessage()    {}
func (*CapabilityCredentialSubject) Descriptor() ([]byte, []int) {
	return fileDescriptor_cf6469f22440938e, []int{10}
}
func (m *CapabilityCredentialSubject) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CapabilityCredentialSubject) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CapabilityCredentialSubject.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CapabilityCredentialSubject) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CapabilityCredentialSubject.Merge(m, src)
}
func (m *CapabilityCredentialSubject) XXX_Size() int {
	return m.Size()
}
func (m *CapabilityCredentialSubject) XXX_DiscardUnknown() {
	xxx_messageInfo_CapabilityCredentialSubject.DiscardUnknown(m)
}

var xxx_messageInfo_CapabilityCredentialSubject proto.InternalMessageInfo

func (m *CapabilityCredentialSubject) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *CapabilityCredentialSubject) GetType() string {
	if m != nil {
		return m.Type
	}
	return ""
...
func (m *CapabilityCredentialSubject) GetAttributes() string {
	if m != nil {
		return m.Attributes
	}
	return ""
...
func (*Proof) Descriptor() ([]byte, []int) {
	return fileDescriptor_cf6469f22440938e, []int{11}
}
...
func init() {
	...
	proto.RegisterType((*ArbitraryCredentialSubject)(nil), "allinbits.cosmoscash.verifiablecredential.ArbitraryCredentialSubject")
	proto.RegisterType((*CapabilityCredentialSubject)(nil), "allinbits.cosmoscash.verifiablecredential.CapabilityCredentialSubject")
...
var fileDescriptor_cf6469f22440938e = []byte{
	...
	,
}
...
func (m *VerifiableCredential_CapabilityCred) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VerifiableCredential_CapabilityCred) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CapabilityCred != nil {
		{
			size, err := m.CapabilityCred.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *VerifiableCredential_ArbitraryCred) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VerifiableCredential_ArbitraryCred) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ArbitraryCred != nil {
		{
			size, err := m.ArbitraryCred.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ArbitraryCredentialSubject) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ArbitraryCredentialSubject) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ArbitraryCredentialSubject) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Attributes) > 0 {
		...
		i = encodeVarintVerifiableCredential(dAtA, i, uint64(len(m.Attributes)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Type) > 0 {
...
func (m *CapabilityCredentialSubject) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CapabilityCredentialSubject) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CapabilityCredentialSubject) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *VerifiableCredential_CapabilityCred) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.CapabilityCred != nil {
		l = m.CapabilityCred.Size()
		n += 1 + l + sovVerifiableCredential(uint64(l))
	}
	return n
}
func (m *VerifiableCredential_ArbitraryCred) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ArbitraryCredentialSubject) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CapabilityCredentialSubject) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VerifiableCredential) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CapabilityCred", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &CapabilityCredentialSubject{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.CredentialSubject = &VerifiableCredential_CapabilityCred{v}
			iNdEx = postIndex
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ArbitraryCred", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &ArbitraryCredentialSubject{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.CredentialSubject = &VerifiableCredential_ArbitraryCred{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *ArbitraryCredentialSubject) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ArbitraryCredentialSubject: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ArbitraryCredentialSubject: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CapabilityCredentialSubject) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CapabilityCredentialSubject: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CapabilityCredentialSubject: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
