...
/** QueryDidDocumentsRequest is request type for Query/DidDocuments RPC method. */
export interface QueryDidDocumentB64Request {
  id_base64: string;
}

/** QueryDidDocumentsResponse is response type for the Query/DidDocuments RPC method */
export interface QueryDidDocumentB64Response {
  didDocument: DidDocument | undefined;
  didMetadata: DidMetadata | undefined;
}
...
const baseQueryDidDocumentB64Request: object = { id_base64: "" };

export const QueryDidDocumentB64Request = {
  encode(
    message: QueryDidDocumentB64Request,
    writer: Writer = Writer.create()
  ): Writer {
    if (message.id_base64 !== "") {
      writer.uint32(10).string(message.id_base64);
    }
    return writer;
  },
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryDidDocumentB64Request {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryDidDocumentB64Request,
    } as QueryDidDocumentB64Request;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.id_base64 = reader.string();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): QueryDidDocumentB64Request {
    const message = {
      ...baseQueryDidDocumentB64Request,
    } as QueryDidDocumentB64Request;
    if (object.id_base64 !== undefined && object.id_base64 !== null) {
      message.id_base64 = String(object.id_base64);
    } else {
      message.id_base64 = "";
    }
    return message;
  ...
  toJSON(message: QueryDidDocumentB64Request): unknown {
    const obj: any = {};
    message.id_base64 !== undefined && (obj.id_base64 = message.id_base64);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryDidDocumentB64Request>
  ): QueryDidDocumentB64Request {
    const message = {
      ...baseQueryDidDocumentB64Request,
    } as QueryDidDocumentB64Request;
    if (object.id_base64 !== undefined && object.id_base64 !== null) {
      message.id_base64 = object.id_base64;
    } else {
      message.id_base64 = "";
    }
    return message;
...
const baseQueryDidDocumentB64Response: object = {};

export const QueryDidDocumentB64Response = {
  encode(
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryDidDocumentB64Response {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryDidDocumentB64Response,
    } as QueryDidDocumentB64Response;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryDidDocumentB64Response {
    const message = {
      ...baseQueryDidDocumentB64Response,
    } as QueryDidDocumentB64Response;
    if (object.didDocument !== undefined && object.didDocument !== null) {
  ...
  toJSON(message: QueryDidDocumentB64Response): unknown {
    const obj: any = {};
    message.didDocument !== undefined &&
      (obj.didDocument = message.didDocument
        ? DidDocument.toJSON(message.didDocument)
  ...
  fromPartial(
    object: DeepPartial<QueryDidDocumentB64Response>
  ): QueryDidDocumentB64Response {
    const message = {
      ...baseQueryDidDocumentB64Response,
    } as QueryDidDocumentB64Response;
...
export interface Query {
  ...
  DidDocumentB64(
    request: QueryDidDocumentB64Request
  ): Promise<QueryDidDocumentB64Response>;
}
...
export class QueryClientImpl implements Query {
  ...
  DidDocumentB64(
    ...
    const data = QueryDidDocumentB64Request.encode(request).finish();
    const promise = this.rpc.request(
      "allinbits.cosmoscash.did.Query",
      "DidDocumentB64",
      data
    ...
    return promise.then((data) =>
      QueryDidDocumentB64Response.decode(new Reader(data))
    );
  }
}
