...
export interface VerifiablecredentialCapabilityCredentialSubject {
  id?: string;
  type?: string;
  attributes?: string;
}
...
export type VerifiablecredentialMsgIssueCredentialResponse = object;

export type VerifiablecredentialMsgRevokeCredentialResponse = object;
...
export interface VerifiablecredentialQueryVerifiableCredentialResponse {
  ...
  verifiable_credential?: VerifiablecredentialVerifiableCredential;
}
...
export interface VerifiablecredentialVerifiableCredential {
  ...
  capability_cred?: VerifiablecredentialCapabilityCredentialSubject;
  arbitrary_cred?: VerifiablecredentialArbitraryCredentialSubject;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/allinbits/verifiablecredentials/verifiablecredentials/{verifiable_credential_id}
   */
  queryVerifiableCredential = (verifiable_credential_id: string, params: RequestParams = {}) =>
    this.request<VerifiablecredentialQueryVerifiableCredentialResponse, RpcStatus>({
      path: `/allinbits/verifiablecredentials/verifiablecredentials/${verifiable_credential_id}`,
      method: "GET",
      format: "json",
      ...params,
    });
