...
export interface VerifiableCredential {
  ...
  capability_cred: CapabilityCredentialSubject | undefined;
  /** all other use cases; ID && arbitrary byte array pair */
  arbitrary_cred: ArbitraryCredentialSubject | undefined;
  /**
...
export interface CapabilityCredentialSubject {
  /** The value of id represents the ID of the credential subject */
  id: string;
  /** The capability type referenced by this claim */
  type: string;
  /**
   * Serialized JSON payload that should adhering to
   * the schema of the aformentioned capability type
   */
  attributes: string;
}
...
export const VerifiableCredential = {
  encode(
    ...
    if (message.capability_cred !== undefined) {
      CapabilityCredentialSubject.encode(
        message.capability_cred,
        writer.uint32(90).fork()
      ).ldelim();
    }
    if (message.arbitrary_cred !== undefined) {
      ArbitraryCredentialSubject.encode(
        message.arbitrary_cred,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9:
          ...
          break;
        case 11:
          message.capability_cred = CapabilityCredentialSubject.decode(
            reader,
            reader.uint32()
          );
          break;
        case 12:
          message.arbitrary_cred = ArbitraryCredentialSubject.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): VerifiableCredential {
    ...
    if (
      object.capability_cred !== undefined &&
      object.capability_cred !== null
    ) {
      message.capability_cred = CapabilityCredentialSubject.fromJSON(
        object.capability_cred
      );
    } else {
      message.capability_cred = undefined;
    }
    if (object.arbitrary_cred !== undefined && object.arbitrary_cred !== null) {
      message.arbitrary_cred = ArbitraryCredentialSubject.fromJSON(
        object.arbitrary_cred
      );
    } else {
      message.arbitrary_cred = undefined;
    }
  ...
  toJSON(message: VerifiableCredential): unknown {
    ...
    message.user_cred !== undefined &&
      (obj.user_cred = message.user_cred
        ...
        : undefined);
    message.capability_cred !== undefined &&
      (obj.capability_cred = message.capability_cred
        ? CapabilityCredentialSubject.toJSON(message.capability_cred)
        : undefined);
    message.arbitrary_cred !== undefined &&
      (obj.arbitrary_cred = message.arbitrary_cred
        ? ArbitraryCredentialSubject.toJSON(message.arbitrary_cred)
        : undefined);
    message.proof !== undefined &&
  ...
  fromPartial(object: DeepPartial<VerifiableCredential>): VerifiableCredential {
    ...
    if (
      ...
      message.capability_cred = CapabilityCredentialSubject.fromPartial(
        object.capability_cred
      );
    } else {
      message.capability_cred = undefined;
    ...
    if (object.arbitrary_cred !== undefined && object.arbitrary_cred !== null) {
      message.arbitrary_cred = ArbitraryCredentialSubject.fromPartial(
        object.arbitrary_cred
      );
    } else {
      message.arbitrary_cred = undefined;
...
const baseCapabilityCredentialSubject: object = {
  id: "",
  type: "",
  attributes: "",
};

export const CapabilityCredentialSubject = {
  encode(
    message: CapabilityCredentialSubject,
    writer: Writer = Writer.create()
  ): Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    ...
    if (message.attributes !== "") {
      writer.uint32(26).string(message.attributes);
    }
    return writer;
  },
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseCapabilityCredentialSubject,
    } as CapabilityCredentialSubject;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): CapabilityCredentialSubject {
    const message = {
      ...baseCapabilityCredentialSubject,
    } as CapabilityCredentialSubject;
    if (object.id !== undefined && object.id !== null) {
  ...
  toJSON(message: CapabilityCredentialSubject): unknown {
    const obj: any = {};
    message.id !== undefined && (obj.id = message.id);
    message.type !== undefined && (obj.type = message.type);
  ...
  fromPartial(
    object: DeepPartial<CapabilityCredentialSubject>
  ): CapabilityCredentialSubject {
    const message = {
      ...baseCapabilityCredentialSubject,
    } as CapabilityCredentialSubject;
