...
import { CapabilityCredentialSubject } from "./module/types/verifiable-credential/verifiable-credential"
import { Proof } from "./module/types/verifiable-credential/verifiable-credential"


export { QueryValidateVerifiableCredentialResponse, VerifiableCredential, UserCredentialSubject, LicenseCredentialSubject, RegulatorCredentialSubject, RegistrationCredentialSubject, LegalPerson, Name, Address, Id, ArbitraryCredentialSubject, CapabilityCredentialSubject, Proof };
...
const getDefaultState = () => {
	return {
				...
				_Structure: {
						...
						CapabilityCredentialSubject: getStructure(CapabilityCredentialSubject.fromPartial({})),
