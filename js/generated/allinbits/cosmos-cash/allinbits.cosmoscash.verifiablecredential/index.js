        ...
        async QueryVerifiableCredentials({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params, query = null }) {
            try {
                ...
                while (all && value.pagination && value.pagination.next_key != null) {
                    let next_values = (await queryClient.queryVerifiableCredentials({ ...query, 'pagination.key': value.pagination.next_key })).data;
        ...
        async sendMsgRevokeCredential({ rootGetters }, { value, fee = [], memo = '' }) {
            try {
                ...
                if (e == MissingWalletError) {
                    ...
                    throw new SpVuexError('TxClient:MsgRevokeCredential:Send', 'Could not broadcast Tx: ' + e.message);
                }
            }
        },
