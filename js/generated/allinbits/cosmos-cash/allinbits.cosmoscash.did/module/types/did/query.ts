...
const baseQueryDidDocumentB64Request: object = { idBase64: "" };
...
export const QueryDidDocumentB64Request = {
  encode(
    ...
    if (message.idBase64 !== "") {
      writer.uint32(10).string(message.idBase64);
    }
    return writer;
  },
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.idBase64 = reader.string();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): QueryDidDocumentB64Request {
    ...
    if (object.idBase64 !== undefined && object.idBase64 !== null) {
      message.idBase64 = String(object.idBase64);
    } else {
      message.idBase64 = "";
    }
    return message;
  ...
  toJSON(message: QueryDidDocumentB64Request): unknown {
    const obj: any = {};
    message.idBase64 !== undefined && (obj.idBase64 = message.idBase64);
    return obj;
  },
  ...
  fromPartial(
    ...
    if (object.idBase64 !== undefined && object.idBase64 !== null) {
      message.idBase64 = object.idBase64;
    } else {
      message.idBase64 = "";
    }
    return message;
