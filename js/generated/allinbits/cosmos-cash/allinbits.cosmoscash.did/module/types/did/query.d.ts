...
export declare const QueryDidDocumentB64Request: {
    encode(message: QueryDidDocumentB64Request, writer?: Writer): Writer;
    decode(input: Reader | Uint8Array, length?: number): QueryDidDocumentB64Request;
    fromJSON(object: any): QueryDidDocumentB64Request;
    toJSON(message: QueryDidDocumentB64Request): unknown;
    fromPartial(object: DeepPartial<QueryDidDocumentB64Request>): QueryDidDocumentB64Request;
};
export declare const QueryDidDocumentB64Response: {
    encode(message: QueryDidDocumentB64Response, writer?: Writer): Writer;
    decode(input: Reader | Uint8Array, length?: number): QueryDidDocumentB64Response;
    fromJSON(object: any): QueryDidDocumentB64Response;
    toJSON(message: QueryDidDocumentB64Response): unknown;
    fromPartial(object: DeepPartial<QueryDidDocumentB64Response>): QueryDidDocumentB64Response;
};
...
export interface Query {
    ...
    DidDocumentB64(request: QueryDidDocumentB64Request): Promise<QueryDidDocumentB64Response>;
}
