...
const baseQueryDidDocumentB64Request = { idBase64: "" };
...
const baseQueryDidDocumentB64Response = {};
...
export class QueryClientImpl {
    ...
    DidDocumentB64(request) {
        const data = QueryDidDocumentB64Request.encode(request).finish();
        const promise = this.rpc.request("allinbits.cosmoscash.did.Query", "DidDocumentB64", data);
        return promise.then((data) => QueryDidDocumentB64Response.decode(new Reader(data)));
    }
}
