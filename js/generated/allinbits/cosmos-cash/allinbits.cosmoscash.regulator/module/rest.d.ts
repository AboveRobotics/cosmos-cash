...
export declare type RegulatorMsgIssueLicenseCredentialResponse = object;
export declare type RegulatorMsgIssueRegistrationCredentialResponse = object;
export declare type RegulatorMsgIssueRegulatorCredentialResponse = object;
